...
def ft_phys(lr, boolean_value, sensor_value, xt, output_func):
    ...
    data = dde.data.TimePDE(geomtime, pde, [], num_domain=1000, solution=func, num_test=10000)
    ...
    losshistory, train_state = model.train(epochs=2000, display_every=50,
...
def main():
    data_test = np.load(f"../../../data/diffusion_reaction/dr_test_ls_0.2_101_101.npz")
