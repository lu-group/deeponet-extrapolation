...
def ft_obs_a(repeat, num_train):
    ...
    y_train = data_test['u_test_select'][repeat]
    ...
    model.train(epochs=1000, display_every=100, model_restore_path=f"model_u/model")
...
def main():
    ...
    np.save(f"predict_ft_obs_a_u.npy", output_list)
